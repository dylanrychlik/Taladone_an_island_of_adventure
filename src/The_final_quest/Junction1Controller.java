 ...
 * @author dylan
 */
public class Junction1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        //intro = "You travel east to the fith junction of the northen region. The sun is beating on your face like your father when you were a kid. \n As you wipe the sweat on your forehead, you notice a tad bit a red drip on your hand as you wipe it. You look up and see blood dripping from the leaves above. \n Upon further inpection, you see the dead body hanged up high from the tree. \n You turn around the cornor and see two more dead. \n There is a mad man on the loose. \n You grab your sword and scream! \n “Show yourself! I work for the Jarl! You don’t want to fight me!”. You then hear rustling from the leaves from the near by bush. \n Out comes an unarmed man that looks very frighten and scared. \n “Get out of here now! They are coming!” He says. An arrow then penatrates him and the man closped to the ground as his breath is cut short and reavles a group of outlaw travelers. ";
        intro = "You go inside the Davenrun Church. You notice the overhead of the church. \n A giant cross of the lord stands over head. It is empty. \n "
                + "Soon the cross begins to vibrate. It vibrates like an earthquake far away in China. \n Soon... the jesus status floats off and lands on the ground. "
                + "\n The jesus heads vaporizes. Out comes a gray face with yellow redish eyes. \n The face screams a demonic scream. It hurts your hears. \n It can be heard from every cornor of davenrun. \n "
                + "Soon the screeching stops and the deep demon voice booms. \n ''I am the sum of dibogical. I have no motives. Only death. \n My doogie head army will destroy you and all of Taladone, \n for it must be destoryed.... and be born a new island.";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_final_quest/Junction2.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 1");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
