 ...
 * @author dylan
 */
public class Junction23Controller implements Initializable {
   ...
   int Enemyhealth = 10;
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       enmies.add("Priest"); 
     enmies.add("Priest");enmies.add("Priest");
              enmies.add("Priest");enmies.add("Priest");
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_final_quest/junction24.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 1");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
