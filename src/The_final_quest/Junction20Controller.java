 ...
 * @author dylan
 */
public class Junction20Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        intro = "more emenies come and attack";
         ...
         enmies.add("Doogie head"); 
          enmies.add("Doogie head"); 
           enmies.add("Doogie head"); 
            enmies.add("Doogie head"); 
             enmies.add("Doogie head"); 
              enmies.add("Doogie head");  enmies.add("Doogie head");  enmies.add("Doogie head"); 
               enmies.add("Doogie head"); 
                enmies.add("Doogie head");  enmies.add("Doogie head"); 
                 enmies.add("Doogie head"); 
                  enmies.add("Doogie head"); 
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_final_quest/junction21.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 1");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
    ...
    public void Drink_potion() {
        if (Player.getpotions() > 0) {
            ...
            intro = " ";
            intro += "\n You drink a health potion to health your self for " + healthpotionhealamount + "Your health is now" + Player.gethealth();
            intro += "\n you have " + Player.getpotions() + "left";
            prompt.clear();
            prompt.setText(intro);
        } else {
