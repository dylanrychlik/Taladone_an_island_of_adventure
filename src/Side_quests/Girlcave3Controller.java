 ...
 * @author dylan
 */
public class Girlcave3Controller implements Initializable {
    ...
    String intro = "You go and clear the cave";
    @FXML
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
                alert.setTitle("Ned");
                intro = "You go back ned. Ned: Thank you advenrure here is 100 gold for your troule. ";
                Player.addbank(100);
