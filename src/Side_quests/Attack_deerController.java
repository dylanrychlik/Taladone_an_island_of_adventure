 ...
 * @author dylan
 */
public class Attack_deerController implements Initializable {
   ...
   private Player you;
    ...
    private TextArea prompt;
     String intro = "Side Quest started: The hunt You go to the centeral fieldof the island. \n Here is where the deer roam for people to gather food. \n You turn and see a deer sitting still and you prepare your bow and arror";
     @FXML
...
intro = "Thank you adventurer here is a little something for you trouble you have added 500 gold \n Side quest completed";  
Player.addbank(500);
