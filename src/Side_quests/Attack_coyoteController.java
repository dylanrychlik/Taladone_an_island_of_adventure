 ...
 * @author dylan
 */
public class Attack_coyoteController implements Initializable {
    ...
    private TextArea prompt;
     String intro = "Side quest started: The coyote \n You go the farm and see the coyotes in the distance. ";
    @FXML
  ...
  enmies.add("Coyote");
    enmies.add("Coyote");
        ...
        current.setText("Quests: \n Side Quest: The coyote \n Objective: Kill the coyotes");
