 ...
 * @author dylan
 */
public class Talk_inn_keeperController implements Initializable {
@FXML
...
@FXML
    ...
    Alert alert = new Alert(Alert.AlertType.INFORMATION);
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/Side_quests/Talk_to_people.fxml"));
     ...
     public void talk2() throws IOException{
         ...
         Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("Inn keep");

        alert.setContentText("Davenrun Inn, you drunken trash! ");
