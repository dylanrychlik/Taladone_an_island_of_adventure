 ...
 * @author dylan
 */
public class Talk_billController implements Initializable {
    ...
    Player player;
     String intro = "Side quest started: The fued. You go talk to bob.";
...
@FXML
    ...
    Alert alert = new Alert(Alert.AlertType.INFORMATION);
     ...
     public void talk2() throws IOException{
        ...
        alert.setContentText("Yeah and so what? Did he tell your his life story? ");
      ...
      Stage Stage = new Stage();
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/Side_quests/Talk_bob.fxml"));
