 ...
 * @author dylan
 */
public class Attack_gang_leaderController implements Initializable {
    ...
    private TextArea prompt;
     String intro = "You go and attack the gang leader ''If my men can't stop you, perhaps I will!'";
    @FXML
