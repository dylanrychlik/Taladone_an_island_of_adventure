 ...
 * @author dylan
 */
public class Talk_bobController implements Initializable {
    ...
    Player player;
     String intro = "You go talk to bob.";
...
@FXML
    ...
    public void talk1(){
     ...
     Alert alert = new Alert(Alert.AlertType.INFORMATION);
        ...
        alert.setContentText("I am too. He was my brother. When my mother was sick and father hunted we had to be there for each other now Bill have become so cold as he gotten older. He seem to only care about himself. ");

         ButtonType ok = new ButtonType("OK");
            alert.getButtonTypes().setAll(ok);
            Optional<ButtonType> new_result = alert.showAndWait();
     }
      public void talk3() throws IOException{
      Stage Stage = new Stage();
        Stage.setTitle("bill and bobs friends");
        Parent root = FXMLLoader.load(getClass().getResource("/Side_quests/talk_to_bob_and_bills_friend.fxml"));
