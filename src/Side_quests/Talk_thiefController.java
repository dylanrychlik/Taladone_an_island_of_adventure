 ...
 * @author dylan
 */
public class Talk_thiefController implements Initializable {
    ...
    Player player;
     String intro = "Side quest started: The thief. You go talk to the thief.";
...
@FXML
   ...
   Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("Thief");

        alert.setContentText("So? I like having things I shouldn't have. I like killing and screwing. ");
...
Alert alert = new Alert(Alert.AlertType.INFORMATION);
        ...
        alert.setContentText("No, I think I'm just gonna kill you!");
         ButtonType ok = new ButtonType("OK");
            alert.getButtonTypes().setAll(ok);
            Optional<ButtonType> new_result = alert.showAndWait();
   Stage Stage = new Stage();
        Stage.setTitle("Thief");
        Parent root = FXMLLoader.load(getClass().getResource("/Side_quests/Attack_tief.fxml"));
