...
public class Attack_bookcave_room1Controller implements Initializable {
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/Side_quests/Attack_bookcave_room2.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow(); 
