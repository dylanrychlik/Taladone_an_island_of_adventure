 ...
 * @author dylan
 */
public class TalkmanController implements Initializable {
    ...
    Player player;
     String intro = "You go talk to the man troubling Victoria.";
...
//ObservableList<String> people = FXCollections.observableArrayList();
        player.getPlayer();
         current.setText("Quests: \n Side Quest: The follower \n Objective: Talk to the man");
    ...
    Alert alert = new Alert(Alert.AlertType.INFORMATION);
     ...
     public void talk2() throws IOException{
      ...
      public void talk3() throws IOException{
        ...
        alert.setContentText("Very well, looks like YOU are going to die.");
