 ...
 * @author dylan
 */
public class Flightless_dragon_cave_room3Controller implements Initializable {
   ...
   private Player you;
    ...
    String intro = " You continie on the cave";
    @FXML
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                 ...
                 Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
        alert.setTitle("Arnold war hammer");
intro = "You go back to Davenrun. You see the Arnold. \n ''You did it! You cleared the cave! Thank you adventure. \n  Here is 50 gold... and a trick to help you in defense. \n Side quests completed";  
