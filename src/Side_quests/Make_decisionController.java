 ...
 * @author dylan
 */
public class Make_decisionController implements Initializable {
@FXML
    ...
    Player player;
     String intro = "You make a decision on who to side with!";
...
//ObservableList<String> people = FXCollections.observableArrayList();
        player.getPlayer();
         current.setText("Quests: \n Side Quest: The Fued \n Objective: Make a decision on who to side with");
