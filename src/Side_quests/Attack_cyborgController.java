 ...
 * @author dylan
 */
public class Attack_cyborgController implements Initializable {
    ...
    private TextArea prompt;
     String intro = "Side quest started: The cyborg. \n You attack the cyborg and the all of sudden a portal apears out of \n nowhere and you travel to future Taladone in the year 2533 when taladone \n is a futristic dystopian city ";
    @FXML
