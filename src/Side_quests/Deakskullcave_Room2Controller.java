 ...
 * @author dylan
 */
public class Deakskullcave_Room2Controller implements Initializable {
  private Player you;
    int Enemyhealth = 10;
    ...
    String intro = " You continuie on the cave";
    @FXML
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/Side_quests/Talkgirl.fxml"));
                Stage.setScene(new Scene(root, 1000, 750));
                Stage.show();
                closeWindow();
