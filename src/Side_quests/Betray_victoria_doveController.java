 ...
 * @author dylan
 */
public class Betray_victoria_doveController implements Initializable {
...
//ObservableList<String> people = FXCollections.observableArrayList();
        player.getPlayer();
         current.setText("Quests: \n Side Quest: The Follwer \n Objective: Confront Victoria Dove");
...
@FXML
    ...
    public void talk1() throws IOException{
        ...
        alert.setTitle("Victoria Dove"); 
         alert.setHeight(275);
            alert.setContentText("In this day and age you shouldn't trust anyone in Davenrun. That is how you get yourself killed. \n Now are you going to give me the gold your do I have put a sword through your brain? \n ");
            ButtonType ok = new ButtonType("Yes");
                    ButtonType no = new ButtonType("No");
            alert.getButtonTypes().setAll(ok,no);
            Optional<ButtonType> new_result = alert.showAndWait();
              // int decide =  JOptionPane.showConfirmDialog(null,"Now are you going to give me the gold your do I have put a sword through your brain? \n");
