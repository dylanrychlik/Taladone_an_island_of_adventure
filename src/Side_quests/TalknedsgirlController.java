 ...
 * @author dylan
 */
public class TalknedsgirlController implements Initializable {
    ...
    Player player;
     String intro = "Side quests started: The shy guy. You go to talk to Neds girl";
...
@FXML
    ...
    Alert alert = new Alert(Alert.AlertType.INFORMATION);
        ...
        alert.setContentText(" We are going to die anyway. Might as well go down with your mind!  ");
     ...
     public void talk2() throws IOException{
        ...
        alert.setContentText("Davenrun is doomed anyway. The Jarl is courrupt and is paid by the areana and casino to tell davenrun what they want to hear. You will die ");
        ...
        Stage.setTitle("Man");
        Parent root = FXMLLoader.load(getClass().getResource("/Side_quests/Attack_man.fxml"));
