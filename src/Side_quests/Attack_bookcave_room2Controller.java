 ...
 * @author dylan
 */
public class Attack_bookcave_room2Controller implements Initializable {
    ...
    String intro = "You see a man with his lower body as a bloody skeleton. \n The man bleeds out and you go and attack. ";
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        current.setText("Quests: \n Side Quest: The Book \n Objective: Return the magic book to Nigil");
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/Side_quests/Attack_bookcave_room3.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow(); 
