 ...
 * @author dylan
 */
public class Talk_to_bob_and_bills_friendController implements Initializable {
...
//ObservableList<String> people = FXCollections.observableArrayList();
        player.getPlayer();
         current.setText("Quests: \n Side Quest: The Fued \n Objective: Talk to bill and bobs friends");
...
@FXML
    ...
    Alert alert = new Alert(Alert.AlertType.INFORMATION);
     ...
     public void talk2() throws IOException{
         ...
         Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("Friend two");

        alert.setContentText("I without question side with Bill.\n  Bob is a lazy maggot who complains about never having gold. \n He spends it on card games and booze in the casino and cooks terrible meals and cleans slow. \n If I was Bill I would kick him out too! ");
