 ...
 * @author dylan
 */
public class Attack_manController implements Initializable {
    ...
    private TextArea prompt;
     String intro = "You go and attack the man ";
    @FXML
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Stage Stage = new Stage();
                Stage.setTitle("Betray Victory Dove");
                Parent root = FXMLLoader.load(getClass().getResource("/Side_quests/Betray_victoria_dove.fxml"));
                Stage.setScene(new Scene(root, 1000, 750));
                Stage.show();
                closeWindow();
