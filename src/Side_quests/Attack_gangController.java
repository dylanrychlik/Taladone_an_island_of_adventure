 ...
 * @author dylan
 */
public class Attack_gangController implements Initializable {
    ...
    String intro = "You go and attack the gang members";
    @FXML
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Stage Stage = new Stage();
                Stage.setTitle("Outside House");
                Parent root = FXMLLoader.load(getClass().getResource("/Side_quests/Attack_gang_leader.fxml"));
                Stage.setScene(new Scene(root, 1000, 750));
                Stage.show();
                closeWindow();
