 ...
 * @author dylan
 */
public class Flightless_dragon_cave_room1Controller implements Initializable {
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/Side_quests/flightless_dragon_cave_room2.fxml"));
                Stage.setScene(new Scene(root, 1000, 750));
                Stage.show();
                closeWindow();
