 ...
 * @author dylan
 */
public class Talk_to_peopleController implements Initializable {
@FXML
    ...
    Player player;
     String intro = "You go to talk to people.";
...
@FXML
    ...
    Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("Person 1");

        alert.setContentText("I'm not the person you want to talk to, \n the person you want to talk to is my brother.  ");
 ...
 Stage Stage = new Stage();
        Stage.setTitle("Gang");
        Parent root = FXMLLoader.load(getClass().getResource("/Side_quests/Talk_to_gang_leader.fxml"));
