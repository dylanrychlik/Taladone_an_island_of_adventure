 ...
 * @author dylan
 */
public class Attack_aliens3Controller implements Initializable {
    ...
    private TextArea prompt;
     String intro = "You last of the aliens and attack, ";
    @FXML
...
intro = "You get off the ship and go back to Davenrun. \n Side quest completed!";  
Player.addbank(30);
