...
public void Slotmachine(){
    ...
    private void addFields() {
        ...
        sepStats2.setOrientation(SwingConstants.VERTICAL);        lblCredits = new JLabel();
    ...
    public int win() {
     ...
     public void slot_machine(){
        //closeWindow();
            ...
            java.util.logging.Logger.getLogger(GameroomController.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
