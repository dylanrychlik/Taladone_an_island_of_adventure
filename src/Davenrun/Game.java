...
public void displayBoard() 
{
  ...
  JOptionPane.showMessageDialog(null,"  0  " + table[0][0] + "|" + table[0][1] + "|" + table[0][2]);
    JOptionPane.showMessageDialog(null,"    --+-+--");
     JOptionPane.showMessageDialog(null,"  1  " + table[1][0] + "|" + table[1][1] + "|" + table[1][2]);
   JOptionPane.showMessageDialog(null,"    --+-+--");
     JOptionPane.showMessageDialog(null,"  2  " + table[2][0] + "|" + table[2][1] + "|" + table[2][2]);
