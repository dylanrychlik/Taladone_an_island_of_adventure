...
public class AttackSkelaton2Controller implements Initializable {
    ...
    public void AttackSlelaton2Controller() {
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                intro = " ";
                Player.addbank(60);
                intro += "You add 60 gold. You bank is now " + Player.getbank();
                prompt.clear();
                prompt.setText(intro);
