...
import static The_eastern_graveyard.Junction1Controller.row10;
import static The_eastern_graveyard.Junction1Controller.row11;
import static The_eastern_graveyard.Junction1Controller.row12;
import static The_eastern_graveyard.Junction1Controller.row13;
import static The_eastern_graveyard.Junction1Controller.row5;
import static The_eastern_graveyard.Junction1Controller.row6;
import static The_eastern_graveyard.Junction1Controller.row7;
import static The_eastern_graveyard.Junction1Controller.row8;
import static The_eastern_graveyard.Junction1Controller.row9;
...
public class Junction2Controller implements Initializable {
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    public void go_Southeast() throws IOException {
        ...
        if (locations[0] == false) {
            ...
            Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/attackJunction1.fxml"));
        ...
        if (locations[0] == true) {
            Stage Stage = new Stage();
            Stage.setTitle("Junction 1");
            Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Junction1.fxml"));
            Stage.setScene(new Scene(root, 1000, 750));
            Stage.show();
            closeWindow();
        }
