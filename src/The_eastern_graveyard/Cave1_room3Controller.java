...
public class Cave1_room3Controller implements Initializable {
 ...
 intro = "You go into the attack an see hear a roar... as the house expands.... the acient \n skeleton dragon of taladone apears.. Ygo and attack. ";
 prompt.setText(intro);
       enmies.add("Acient skeleton dragon of Taladone");
