 ...
 * @author The flash
 */
public class Cave4room2Controller implements Initializable {
...
intro = "You see a woman and an older man. The olderman is the ground with his arm broken. \n The lead protector grabs the woman by hair and drags her a she screams. \n \n ''I ran intro 'Wanderers' once. I lost everything I loved... including a son. \n This commintment is the only thing keeps me from stabbing myself... \n its the worse pain the universe... \n this whole job is the sole purpose for my exsitance... \n and anyone who stands in the way of my job shall suffer the same faith. \n Your bastard husband is dead.. I'm about to kill your dad... \n and you'll watch your children... who are in the attic.. die'' \n ''NO!!! NO!!!!'' she screams  \n as he soves her and he stabs her dad through the back of his head. \n ''No one is gonna save you this time''. \n ''Thats where you are wrong, bucko.'' you say and you attack and \n the man takes the woman to the attic... ";
prompt.setText(intro);
   enmies.add("protectror");
enmies.add("protectror");
enmies.add("protectror");
enmies.add("protectror");
enmies.add("protectror");
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave4room3.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 4");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
