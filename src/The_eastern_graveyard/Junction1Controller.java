...
public class Junction1Controller implements Initializable {
    ...
    String intro = "Enemies in area are defeated!  ";
    ...
    public void initialize(URL url, ResourceBundle rb) {
          Player.addbank(30);
                intro += "\n You add 30 gold. You bank is now " + Player.getbank();
                intro += "\n What will you do?";
                prompt.clear();
...
//ObservableList<String> people = FXCollections.observableArrayList();
   ...
   Map.setPrefWidth(375);
    ...
    public void go_NorthWest() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Golden_Wine_berry_inn.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
