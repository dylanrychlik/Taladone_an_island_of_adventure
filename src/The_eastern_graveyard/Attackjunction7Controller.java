 ...
 * @author The flash
 */
public class Attackjunction7Controller implements Initializable {
 ...
 intro =  "You come to the 7th Junction in the Eastern region. \n You hear a faint hollow in the distance. Towards the east. \n The mist becomes thicker. \n It begins to get difficult to see. \n Objects more than 30 feet away are extremly hard to see. \n In the mist a faint regiure appears followed by a screeching hollow. \n You go to grab your sword in defense. In the thick mist \n a set of yellow eyes appears from the figure \n and pale white skin appear in the humannoid figure and then you attempt to run towards it. \n Two more begin to follow shortly behind him. \n You have run into a group of eastern tadlone ghouls.";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Player.gethealth() < 0) {
            ...
            if (result.get() == Yes) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/attackJunction6.fxml"));
...
locations[6] = true;
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/junction7.fxml"));
                Stage stage = new Stage();
