 ...
 * @author The flash
 */
public class Cave7room1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You go in and see 2 coffins near a man. \n ''Ha! You activated my trap... now prepare to die!'' - he says \n and two drawg come and them and the man attack. ";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave7room2.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 7");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
