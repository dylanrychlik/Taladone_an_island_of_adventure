...
public class Cave8Controller implements Initializable {
 ...
 String intro = " You come to raptor cave. Here a pack of rapors lay.";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    private void doAction2(String listItem) {
      ...
      public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave8room1.fxml"));
    ...
    public void go_North() throws IOException {
      ...
      public void go_East() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave9.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
