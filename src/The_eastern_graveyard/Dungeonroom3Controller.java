...
public class Dungeonroom3Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You go to the 3rd room. 3 doogieheads tear run with  swords \n and tear and entire family apart limb from limb \n as blood spews everywhere. \n you go and attack.";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
           ...
           //     Thread.sleep(3000);
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/dungeonroom4.fxml"));
                Stage stage = new Stage();
