...
public class Dungeonroom2Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "The doogies come in a wave of 4 as they tear the head off of a man \n and he become a doogie head too";
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
               ...
               // Thread.sleep(3000);
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/dungeonroom3.fxml"));
                Stage stage = new Stage();
