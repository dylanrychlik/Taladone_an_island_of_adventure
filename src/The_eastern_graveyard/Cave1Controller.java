...
import static The_eastern_graveyard.Junction2Controller.row12;
...
public class Cave1Controller implements Initializable {
    String intro = "You come to skelaton dead house. \n Where the dead from the graves within rise and eat the flesh of adventure who venture by. \n The skelatons, have no morals, no modivation, and no goals, all they do is feast on the flesh of the inocent. \n The mist is thick in the eastern region. \n You look inside the window to see a figure in the distance. \n As the figuire gets coser and closer the bones of the undead skeleton become visible. \n You heart races and you back away with your sword drawn in the sight of the house. \n The skeleton is kocking on the window. \n As time goes on, the knocking gets louder and louder until it is hurting your hears. \n Then it stops. Dead silence. \n A locked is heard from the door. Do you wish to go inside or continue on the the deamons lair. ";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    public void go_Southeast() throws IOException {
     if (locations[1] == false) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/attackJunction2.fxml"));

        Stage stage = new Stage();

        stage.setTitle("Junction 2");
        stage.setScene(new Scene(root, 1000, 750));
        stage.show();
        closeWindow();
    }
        if (locations[1] == true) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Junction2.fxml"));
   ...
   public void go_inside_boldmans_areana() throws IOException {
    ...
    public void go_East() throws IOException {
        ...
        if (locations[2] == true) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Junction3.fxml"));
