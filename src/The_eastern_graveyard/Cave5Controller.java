...
import static The_eastern_graveyard.Cave10Controller.row9;
import static The_eastern_graveyard.Junction1Controller.row13;
import static The_eastern_graveyard.Junction5Controller.row10;
import static The_eastern_graveyard.Junction5Controller.row11;
import static The_eastern_graveyard.Junction5Controller.row5;
import static The_eastern_graveyard.Junction5Controller.row6;
import static The_eastern_graveyard.Junction5Controller.row7;
import static The_eastern_graveyard.Junction5Controller.row8;
import static The_eastern_graveyard.Junction5Controller.row9;
...
public class Cave5Controller implements Initializable {
    String intro = "You come to Ghoul deadhouse. Here is where the Eastern Taladone Ghoul lay. \n The mist creep up on your skins as it crawls from the sight of the house. \n Your heart races as it looks into the window. \n You look in the windows and see nothing. \n Five seconds later, you hear a screch from inside the house. \n About 50 bats come out of no where and fly around. \n You duck in fear of getting bitten, with your sword drawn and you are ready for anything to attack. If you go insdie who knows what treasures lay inside. Do you want to go inside?";
...
//ObservableList<String> people = FXCollections.observableArrayList();
   ...
   row1.clear();
    ...
    private void doAction2(String listItem) {
      ...
      public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave5room1.fxml"));
 ...
 Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave3.fxml"));
    ...
    public void go_North() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave7.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
