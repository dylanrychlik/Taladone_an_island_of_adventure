 ...
 * @author The flash
 */
public class Attackjunction8Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You travel the 8th junction of the eastetrn region \n The mist gets a little thicker making it hard to see beyond 20. \n You can’t see anything beyond 30 feet. \n As you are walking you hear an stern voice. \n “Get out of here traveler. It is not safe here. \n Death will come to you. Go back to davenrun where you belong. \n ” “I was sent here by the jarl.” you say in defense. \n “Get out of here now. You will regret. ” - the figure says and it \n realives an old man with a cane. “Make me old fool! I will gut you like a fish. \n Before the man could say anything a set of arms attack the man  \n and begins to rip his flesh. \n as the man if screaming for mercy you back away as you see you bumin \n to two doogiea behind and arms attacking the man realives a third one. ";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Player.gethealth() < 0) {
            ...
            if (result.get() == Yes) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/attackJunction7.fxml"));
