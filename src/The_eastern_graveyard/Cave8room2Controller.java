...
public class Cave8room2Controller implements Initializable {
   ...
   private Player you;
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       intro = "You go and see 3 more raptors tear an old man apart. You go and attack ";
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
              ...
              //  Thread.sleep(3000);
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave8room3.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 8");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
