 ...
 * @author The flash
 */
public class Cave9room2Controller implements Initializable {
  ...
  private Player you;
    ...
    public void initialize(URL url, ResourceBundle rb) {
      ...
      intro = "You go inside and see a little girl. \n ''Wheres my mommy? I'm scared''. \n There steps coming from the attic. \n ''Help me! I'm scared! HELP ME!!! HELP ME!!'' as the redcap drags the girl to \n the ground with a group of 5 and he stabs the girl in the head tearing her brain apart. \n You bring hell into the repcaps "; 
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave9room3.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 9");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
