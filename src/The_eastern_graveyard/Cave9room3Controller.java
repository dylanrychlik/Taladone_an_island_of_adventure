 ...
 * @author The flash
 */
public class Cave9room3Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     intro = "You go inside the house and see red cap leader standing. \n It then screams so loud that it hurts your ears. \n You march to attack it.";
        prompt.setText(intro);
        enmies.add("redcap leader");
    ...
    public void attack() throws IOException, InterruptedException {
     ...
     Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
            alert.setTitle("Confirmation!");
Player.addbank(150);
            alert.setContentText("Cave cleared! You add 150 gold. Your gold is now "+ Player.getbank() +  "You find the sword and armor. \n  Do you wish to equip it to add  to your health rating or do to add it to your inventory?"
                    + "");
