 ...
 * @author The flash
 */
public class Cave4room1Controller implements Initializable {
...
intro = "You sneak and hide behind a table, beyond the table is a man and \n protector puching the man. \n ''We are the grave protectors... we protect the graveyard at all costs.. \n and whoever comes here at pays the price!  '' \n The protecter then takes his sword and decaptiates the man. \n ''Search the house! I wanna make the woman watch her children die so she knows to, \n never come here again!'' - the man says. You jump out \n and attack while the man goes upstairs.''"; 
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave4room2.fxml"));
                Stage stage = new Stage();
