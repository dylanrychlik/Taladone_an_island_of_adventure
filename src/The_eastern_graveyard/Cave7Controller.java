...
String intro = "You come to the duarg cave. Here the taladones undead duarg live. \n They have magic power \n and comes from the unblessed graves to kill any who dare cross thier path. \n Do you wish to go inside?";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    private void doAction2(String listItem) {
      ...
      public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave7room1.fxml"));
    ...
    public void go_West() throws IOException {
      ...
      public void go_East() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave6.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
