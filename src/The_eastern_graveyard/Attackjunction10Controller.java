...
public class Attackjunction10Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You come to the 10th Jucntion in the eastern region. \n You can’t see 10 feet in front of your and wind is hollwoing like a wolf \n as you walk you hear a loud howl so loud that \n it can heard from the graveyard gate \n 3 coyotes on its hind legs running towards you with blood on its mouth.";
        prompt.setText(intro);
        enmies.add("demon coyote");
        enmies.add("demon coyote");
        enmies.add("demon coyote");
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Player.gethealth() < 0) {
            ...
            if (result.get() == Yes) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/attackJunction9.fxml"));
