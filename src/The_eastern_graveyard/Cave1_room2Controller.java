 ...
 * @author The flash
 */
public class Cave1_room2Controller implements Initializable {
  private Player you;
    int Enemyhealth = 10;
    String intro;
 ...
 intro = "You see a man upstairs. ''I am the keeper of this house.... I control... these... skeletons! \n With that power, I rage war on the Eastern region. \n I plan to be so powerful.... even the demon of the east will bow down.'' - \n he said. ''I will stop at nothing to stop you... and Ill have the head of \n the demon... to save Taladone'' - you say \n  ''Then you will die'' - he say and him and the skelatons attack";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave1_room3.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 1");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
