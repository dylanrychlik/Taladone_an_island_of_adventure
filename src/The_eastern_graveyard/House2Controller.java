...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    public void go_South() throws IOException {
     if (locations[11] == false) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Attackjunction12.fxml"));
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Junction12.fxml"));
    ...
    public void go_North() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Easterncrossing.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
    ...
    public void go_East() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/House2.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
