 ...
 * @author The flash
 */
public class Cave5room2Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       intro = "You see a man shaking upstair! ''Get of here now! They are everywhere!!'' \n Suddely 5 ghouls take the man to the other room \n You go in the room and see an empty room. The door shuts behind you \n You look at the door, then behind you again to see 5 ghouls staring at yuour. \n You go and attack. ";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave5room3.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 5");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
