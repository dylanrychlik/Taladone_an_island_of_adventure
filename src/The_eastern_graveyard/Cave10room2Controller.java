 ...
 * @author The flash
 */
public class Cave10room2Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You go upstairs in the dead house. You see woman trapped in a chain , bleeding. \n ''Help me... I got bit by the wolf. I can't... I can't breath... AHHHHHH!!!!'' - \n she screams as she transforms into a werwwolves and \n four more join with here and you attack.";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave10room3.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 10");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
