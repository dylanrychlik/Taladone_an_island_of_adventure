 ...
 * @author The flash
 */
public class Cave5room3Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You go inside the attic and see the last of the Ghouls... \n a child is the room screeching as the gouls try to take him away. \n You go and attack";
...
enmies.add("Ghoul");
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            alert.setTitle("Confirmation!");
Player.addbank(150);
            alert.setContentText("Cave cleared! You add 150 gold. Your gold is now "+ Player.getbank() +  "You find armor. \n  Do you wish to equip it to add  to your health rating or do to add it to your inventory?"
                    + "");
          ...
          Armoritem.addLast(Cave3Armor);
            ...
            // Armoritem.addLast(Cave4Armor);
                ...
                Stage Stage = new Stage();
                Stage.setTitle("Cave 5");
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/5.fxml"));
                Stage.setScene(new Scene(root, 1000, 750));
                Stage.show();
                closeWindow();
            }
