 ...
 * @author The flash
 */
public class Cave10room3Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
      ...
      intro = "You go into the attic. You see a child chained up... ''Help... I'm the little red riding... \n don't let the big bad wolf get you... you'll know nothing but pain'' - \n and big bad wolf comes and \n tears the little 8 year old girl to shred as blood spews everywhere. \n You watch in horror and you then go and attack.   ";
      prompt.setText(intro);
        enmies.add("Big bad wolf");
...
Player.addbank(200);
            ...
            alert.setContentText("Cave cleared! You add 200 gold. Your gold is now "+ Player.getbank() +  "You find the Bow of the outlaw traveler \n  Do you wish to equip it to add  to your armor and attack damage? or do to add it to your inventory?"
                    + "");
            ...
            Optional<ButtonType> result = alert.showAndWait();
            if (result.get() == Yes) {
             Weapon  Cave4Weapon = new Weapon("3","Bow of the outlaw traveler","Created 100 years ago during the Traveler and Adventurer war. \n Powerful weapons were created using the warriors resourcse and ensued an awful war in which was solved. \n Most of these weapon were destroyed or use up but rare items can be found in depths of Taladone.",110,100);
