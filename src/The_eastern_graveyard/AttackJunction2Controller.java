 ...
 * @author The flash
 */
public class AttackJunction2Controller implements Initializable {
  private Player you;
    int Enemyhealth = 10;
    String intro;
 ...
 intro = "You come to the second Junction in the Eastern GraveYard. \n It is a clear night. You look up above and \n see the big dipper and north star in the clear sky.  \n All you see is the graveyards in the distance you hear a misfying sound \n Hello?” You cry out, as the noise comes closer your can hear the \n creature but not see it. \nYou draw your sword. The creature shatters a nearby gravestone \n  and snaps a branch from a tree \n “Show your self! I’m not afraid to cut your throat if I have to!” \n You turn around and see a group of ghost charge to attack you charge agasint them.";
