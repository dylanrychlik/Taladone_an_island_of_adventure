...
public class Cave5room1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You go inside. You see a dark shadow. Suddely big yellow eyes apear and \n 3 ghouls crawl towards with a demon like screech!";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave5room2.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 5");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
