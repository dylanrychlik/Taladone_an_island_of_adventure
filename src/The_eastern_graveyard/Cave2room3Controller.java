 ...
 * @author The flash
 */
public class Cave2room3Controller implements Initializable {
...
intro = "You see a helpless woman chained up she is scared... You see the ultimeate Vampire of Taladone... Dracula himself. \n ''Ahhh.... adventure looks you both picked a good day to die!'' - said. \n ''Let her go!'' - you say. ''Glady... then I will take care of you!'' - \n he says you go and attack!";
   ...
   intro += "\n Your encounter with " + enmies.toString() + "\n Your health is " + Player.gethealth()
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            alert.setTitle("Confirmation!");
Player.addbank(150);
            alert.setContentText("Cave cleared! You add 150 gold. Your gold is now "+ Player.getbank() +  "You find the king cat health necklace. \n  Do you wish to equip it to add  to your health rating or do to add it to your inventory?"
                    + "");
            ...
            Optional<ButtonType> result = alert.showAndWait();
            if (result.get() == Yes) {
             goodItem  Cave4Weapon = new   goodItem("4","king cat health necklace","Acient king cat necklace forge by the taladone arts... acient powers, it creates... life its self.",110,120);
