...
import static The_eastern_graveyard.Cave2Controller.row10;
import static The_eastern_graveyard.Cave2Controller.row11;
import static The_eastern_graveyard.Cave2Controller.row5;
import static The_eastern_graveyard.Cave2Controller.row6;
import static The_eastern_graveyard.Cave2Controller.row7;
import static The_eastern_graveyard.Cave2Controller.row8;
import static The_eastern_graveyard.Cave2Controller.row9;
import static The_eastern_graveyard.Golden_Wine_berry_innController.row10;
import static The_eastern_graveyard.Golden_Wine_berry_innController.row11;
import static The_eastern_graveyard.Golden_Wine_berry_innController.row5;
import static The_eastern_graveyard.Golden_Wine_berry_innController.row6;
import static The_eastern_graveyard.Golden_Wine_berry_innController.row7;
import static The_eastern_graveyard.Golden_Wine_berry_innController.row8;
import static The_eastern_graveyard.Golden_Wine_berry_innController.row9;
import static The_eastern_graveyard.Junction2Controller.row10;
import static The_eastern_graveyard.Junction2Controller.row11;
import static The_eastern_graveyard.Junction2Controller.row5;
import static The_eastern_graveyard.Junction2Controller.row6;
import static The_eastern_graveyard.Junction2Controller.row7;
import static The_eastern_graveyard.Junction2Controller.row8;
import static The_eastern_graveyard.Junction2Controller.row9;
import static The_eastern_graveyard.Northen_bridgeController.locations;
import static The_eastern_graveyard.Northen_bridgeController.row10;
import static The_eastern_graveyard.Northen_bridgeController.row11;
import static The_eastern_graveyard.Northen_bridgeController.row13;
import static The_eastern_graveyard.Northen_bridgeController.row5;
import static The_eastern_graveyard.Northen_bridgeController.row6;
import static The_eastern_graveyard.Northen_bridgeController.row7;
import static The_eastern_graveyard.Northen_bridgeController.row8;
import static The_eastern_graveyard.Northen_bridgeController.row9;
...
public class Cave3Controller implements Initializable {

    String intro = " You come to zombie dead house, here is where the recent dead come back \n to feats of the flesh, as you coem to the house \n as hear a knock on the winow that gets faster and louder as you get \n  closer as you go near it. you see the zombie in full sight, ready to fest on you. \n If this house if cleared than no longer will a man have to worry \n about creature coming to attack. ";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    public void go_NorthEast() throws IOException {
        ...
        if (locations[4] == false) {
            Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/AttackJunction5.fxml"));

            Stage stage = new Stage();

            stage.setTitle("Junction 5");
            stage.setScene(new Scene(root, 1000, 750));
            stage.show();
            closeWindow();
        }
        if (locations[4] == true) {
            Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Junction5.fxml"));
    ...
    public void go_North() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave5.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
    ...
    public void go_West() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave2.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
    ...
    public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave3room1.fxml"));
    ...
    public void go_East() throws IOException {
            ...
            Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Junction4.fxml"));
