...
intro = "You go and see a classy wampire drinking a glass of red blood. \n ''Ahhh... adventurer... you make a tasty snack'' \n  ''You make a sufficent kill for me... to save Taladone'' - you say \n ''hahahah foolish human... you will die then... undie'' \n He say and he and his woman vampires attack. ";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave2room2.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 2");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
