...
public class Dragons_lairController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You come to the far east and fine in a rooma and window stands to eartern shore and around the cornor.. reaivles... the demon of the east!";
        
        prompt.setText(intro);
        enmies.add("The Demon of the East");
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Player.gethealth() < 0) {
            ...
            if (result.get() == Yes) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Westerncrossing.fxml"));
