...
import static The_eastern_graveyard.Golden_Wine_berry_innController.row12;
...
row1.clear();
   ...
   public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/Davenrun/Inside_Golden_Wine_berry_inn.fxml"));
