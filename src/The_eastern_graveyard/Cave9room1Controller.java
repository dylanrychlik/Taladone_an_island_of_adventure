 ...
 * @author The flash
 */
public class Cave9room1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You go inside the house and see 3 redcaps standing. \n The speak a demonic backwards english. \n The translation is writtin in blood on the floor near the dead women and children. \n ''Leave now traveler! Or else you'll suffer the same faith'' \n You go and attack.";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                //Thread.sleep(3000);
                Parent root = FXMLLoader.load(getClass().getResource("/The_eastern_graveyard/Cave9room2.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 9");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
