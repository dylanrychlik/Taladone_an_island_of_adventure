...
public class Cave10Controller implements Initializable {
    ...
    String intro = " You to priate mother ship \n Here, the lengedy taladone pirates havoc to anyone who dares cross them . \n Do you wish to go inside?";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Cave10room1.fxml"));
