 ...
 * @author The flash
 */
public class Cave8room2Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You then go inside and see another man fending off five of them. \n An arm then goes though his arse and out the top of his head. \n The mermen thens goes and attacks.";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                //  Thread.sleep(3000);
                Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Cave8room3.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 8");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
