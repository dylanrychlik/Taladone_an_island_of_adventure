...
public class Cave5Controller implements Initializable {
 ...
 String intro = "Welcome to crab claw cave. Here the giant mud crab lurks within the cave. Do you wish to go inside?";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    private void doAction2(String listItem) {
      ...
      public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Cave5room1.fxml"));
 ...
 Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Cave3.fxml"));
    ...
    public void go_North() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Cave7.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
