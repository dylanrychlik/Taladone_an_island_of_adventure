...
import static The_southern_ocean.Junction2Controller.row12;
...
public class Cave1Controller implements Initializable {
    String intro = "ou come to shark under cave. +"
           + "\n Here a pack of Sharks lie within the cave. +"
           + "\n The waves crash the outside of the cave,\n  "
           + "the hole looks deep and the adventure looks deeper, \n do you wish to lurk within? \n DO you wish to go inside?";
 ...
 StringBuilder builder = new StringBuilder(row1.size());
    ...
    public void go_Southeast() throws IOException {
     if (locations[1] == false) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/attackJunction2.fxml"));
   ...
   public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Cave1_room1.fxml"));
