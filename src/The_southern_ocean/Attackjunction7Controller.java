...
public class Attackjunction7Controller implements Initializable {
 ...
 intro =  "You come to the 7th Junction in the Eastern region. You come to the 7th Junction \n in the souther region The water is dark and hard to see. Int he distance \n you see a little fish You go to get closer the fish and it realves three \n white sharks swimming directly towardds you. \n" +
".";
 prompt.setText(intro);
    
enmies.add("white sharks");
enmies.add("white sharks");
enmies.add("white sharks");
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Player.gethealth() < 0) {
            ...
            if (result.get() == Yes) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/attackJunction6.fxml"));
