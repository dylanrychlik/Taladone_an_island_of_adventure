...
public class Cave5room3Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You see the king crab of Taladone and you go and attack.";
        prompt.setText(intro);
        enmies.add("King crab of Taladone");
...
Player.addbank(150);
          ...
          Armoritem.addLast(Cave3Armor);
            ...
            // Armoritem.addLast(Cave4Armor);
                ...
                Stage Stage = new Stage();
                Stage.setTitle("Cave 5");
                Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/5.fxml"));
                Stage.setScene(new Scene(root, 1000, 750));
                Stage.show();
                closeWindow();
            }
