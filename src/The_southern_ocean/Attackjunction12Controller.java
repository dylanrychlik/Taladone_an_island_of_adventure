...
public class Attackjunction12Controller implements Initializable {
 ...
 intro =  "You travel 12th junction of the southern region. You come to the 12th \n Junction in the souther region. As you are a swimming towards the final corssing \n to the sea monster lair  another group of hammerhead sharks comes swimming towrads you.  ";
 prompt.setText(intro);
   enmies.add("Hammerhead shark");
enmies.add("Hammerhead shark");
enmies.add("Hammerhead shark");
