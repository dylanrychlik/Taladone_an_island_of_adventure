...
import static The_southern_ocean.Cave10Controller.row10;
import static The_southern_ocean.Cave10Controller.row11;
import static The_southern_ocean.Cave10Controller.row12;
import static The_southern_ocean.Cave10Controller.row5;
import static The_southern_ocean.Cave10Controller.row6;
import static The_southern_ocean.Cave10Controller.row7;
import static The_southern_ocean.Cave10Controller.row8;
import static The_southern_ocean.Cave10Controller.row9;
import static The_southern_ocean.Junction1Controller.row13;
import static The_southern_ocean.Junction5Controller.row10;
import static The_southern_ocean.Junction5Controller.row11;
import static The_southern_ocean.Junction5Controller.row5;
import static The_southern_ocean.Junction5Controller.row6;
import static The_southern_ocean.Junction5Controller.row7;
import static The_southern_ocean.Junction5Controller.row8;
import static The_southern_ocean.Junction5Controller.row9;
...
intro = "You come to merman warrior cave. Here the water is over 30 feet deep and \n a sign appear that say if you wish to find the 4th clue \n of the evil of the island go inside. Do you wish to go inside?";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    private void doAction2(String listItem) {
      ...
      public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Cave8room1.fxml"));
    ...
    public void go_South() throws IOException {
      ...
      if (locations[7] == false) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/attackjunction8.fxml"));
        ...
        if (locations[7] == true) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/junction8.fxml"));
    ...
    public void go_North() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/junction9.fxml"));
