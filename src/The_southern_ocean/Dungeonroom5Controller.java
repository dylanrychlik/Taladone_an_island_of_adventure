...
public class Dungeonroom5Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You come to end of the dungeaon. You see a small pool of water. The pool shakes slight as a 10 foot tall man squid king comes at you. It charges towards you take your sword and charge.";
        prompt.setText(intro);
        enmies.add("Giant man squid");
