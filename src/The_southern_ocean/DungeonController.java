...
public class DungeonController implements Initializable {
    ...
    String intro = "You come the man squid dungean. Here mystorus 6 feet tall mansquid live within. \n They hunt in pacts and attack anything that comes within it \n Do you wish to go inside?";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    public void go_inside_boldmans_areana() throws IOException {
        ...
        Stage.setTitle("Inside Dungeon");
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/dungeonroom1.fxml"));
    ...
    public void go_North() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Westerncrossing.fxml"));

        Stage stage = new Stage();

        stage.setTitle("Western crossing");
        stage.setScene(new Scene(root, 1000, 750));
        stage.show();
        closeWindow();
    }
