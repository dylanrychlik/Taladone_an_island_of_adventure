...
public class Cave5room1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You go inside the crab cave. The crabs come and stab a couple of helpless men \n and carry them around like a broken block of cheese. ''Help me!! Somebody!!'' - they scream. \n The crabs then snap the men in two as their intestines spew blood everywhere. ";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Cave5room2.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 5");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
