...
public class Attackjunction10Controller implements Initializable {
 ...
 intro =  "You come to the 10th Jucntion in the southern region. \n In the distance, you can hear a dramitic faint hollow noise. \n You draw your sword in mad fear. From the distance you can see \n a figuire coming by. \n The figure dissapear and reapears 10 feet in front of your face. \n It it a little girl. The girl open it s eyes and startes directing \n towards the girls face then turns into a deamons like scream";
 prompt.setText(intro);
     enmies.add("Demonic little girl");
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Player.gethealth() < 0) {
            ...
            if (result.get() == Yes) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/attackJunction9.fxml"));
