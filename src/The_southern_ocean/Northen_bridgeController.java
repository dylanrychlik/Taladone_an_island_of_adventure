...
public static boolean[] locations = new boolean[30];
    String intro = "Quest started: The southern ocean. The southern hill  - \n You come to the southern hill that connects \n the central region to the southern peninsula of the island. \n Beyond the hill is mysterious, a small part of the island, but eye is easily fooled. \n For under the waters of the souther ocean, even the most human can breath.\n  A sea monster lurks with the end of souther region. \n The Jarl wants me to destory the Sea Monster \n and take out any doogia head if you see them.";
