...
public class Dungeonroom1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "The man squids come and attack a man, tearing his flesh off, and exposing his red coated bones. \n The man squid then grabs the mans heart out and the mans fall to the ground \n and a pool of blood souurounds him";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/dungeonroom2.fxml"));
                Stage stage = new Stage();
