 ...
 * @author The flash
 */
public class Cave8room3Controller implements Initializable {
   ...
   private Player you;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "A merman king then comes and attacks. You. You grab your sword and charge.";
        prompt.setText(intro);
         enmies.add("merman king");
 ...
 locations[19] = true;
            ...
            alert.setTitle("Confirmation!");
Player.addbank(150);
            alert.setContentText("Cave cleared! You add 150 gold. Your gold is now "+ Player.getbank() +  "You find the Health potion of reqular and armor. \n  Do you wish to equip it to add  to your health rating or do to add it to your inventory?"
                    + "");
