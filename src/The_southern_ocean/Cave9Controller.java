...
public class Cave9Controller implements Initializable {
    String intro = "You come to the mermaid warrior cave. Here the mermanid warriors lay within ";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    private void doAction2(String listItem) {
      ...
      public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Cave9room1.fxml"));
    ...
    public void go_North() throws IOException {
         if (locations[9] == false) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/attackjunction10.fxml"));

        Stage stage = new Stage();

        stage.setTitle("Junction 10");
        stage.setScene(new Scene(root, 1000, 750));
        stage.show();
        closeWindow();
    }
        if (locations[9] == true) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Junction10.fxml"));
      ...
      public void go_West() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Cave8.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
