...
public class EasterncrossingController implements Initializable {
   ...
   String intro = "Welcome towestern crossing. This is the one of way \n you can cross to get to the sea monster lairs. " + "\n Inside the corssing a creature of unknown lurks within. Waiting to attack you" + "\n Do you wish to go inside?";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    public void go_inside() throws IOException {
        Stage Stage = new Stage();
        Stage.setTitle("Inside Eastern  Crossing");
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Insideeasterncrossing.fxml"));
