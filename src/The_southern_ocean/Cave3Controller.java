...
import static The_southern_ocean.Cave2Controller.row10;
import static The_southern_ocean.Cave2Controller.row11;
import static The_southern_ocean.Cave2Controller.row5;
import static The_southern_ocean.Cave2Controller.row6;
import static The_southern_ocean.Cave2Controller.row7;
import static The_southern_ocean.Cave2Controller.row8;
import static The_southern_ocean.Cave2Controller.row9;
...
import static The_southern_ocean.Junction2Controller.row10;
import static The_southern_ocean.Junction2Controller.row11;
import static The_southern_ocean.Junction2Controller.row5;
import static The_southern_ocean.Junction2Controller.row6;
import static The_southern_ocean.Junction2Controller.row7;
import static The_southern_ocean.Junction2Controller.row8;
import static The_southern_ocean.Junction2Controller.row9;
...
public class Cave3Controller implements Initializable {
    ...
    String intro = "You come to the anger cave. Here the myster angler fish dim the darkness of this undercave. \n You see sublte lights as you lurk within the cave. \n The water from the cave crash your feet wetting your pants and the smell of salt become stronger. \n You have your sword by your side and take a deep breath. \n Do you wish to go inside?";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    public void go_NorthEast() throws IOException {
        ...
        if (locations[4] == false) {
            Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/AttackJunction5.fxml"));
    ...
    public void go_East() throws IOException {
            ...
            Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Junction4.fxml"));
