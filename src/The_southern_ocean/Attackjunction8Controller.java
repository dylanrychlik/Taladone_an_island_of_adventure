...
public class Attackjunction8Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You travel the 8th junction of the eastetrn region. You come to the 8th Jucntion \n in the southern region. In the distance you hear a faint holow. \n The hollow drops you on your tracks. The hollow sound slike a girl singing. \n The follow goes on and off for a couple of minuites before it begins to get louder. \n As the singing gets louder a small fish eapers int he distance. \n The swimming seems to come from it. As you get closer to it the \n singing gets louder and the fish gets bigger. As you come \n to it it realves a giant whale coming straight towars you draw you sword and attack it.";
        prompt.setText(intro);
      enmies.add("giant whale");
