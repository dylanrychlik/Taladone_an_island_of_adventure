...
public class Cave5room2Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        intro = "You go inside the and see a bunch of dead. You also see a pack of raptors come and the crabs take them out. The crabs come and attack";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Cave5room3.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 5");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
