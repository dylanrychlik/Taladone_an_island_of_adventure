...
public class Cave10room3Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You go and fight the captain... unfourtantly the woman and children are dead by the time you get there";
        prompt.setText(intro);
        enmies.add("Pirate captain");
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Player.gethealth() < 0) {
            ...
            if (result.get() == Yes) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Cave10.fxml"));
