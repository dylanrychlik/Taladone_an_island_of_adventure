...
public class Cave9room1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You then and go attack see the mermaids as you get closer they feel threatened \n and then go and attack you.";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                //Thread.sleep(3000);
                Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Cave9room2.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 9");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
