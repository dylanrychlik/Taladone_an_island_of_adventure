...
import static The_southern_ocean.House1Controller.row10;
import static The_southern_ocean.House1Controller.row11;
import static The_southern_ocean.House1Controller.row12;
import static The_southern_ocean.House1Controller.row5;
import static The_southern_ocean.House1Controller.row6;
import static The_southern_ocean.House1Controller.row7;
import static The_southern_ocean.House1Controller.row8;
import static The_southern_ocean.House1Controller.row9;
...
public class House2Controller implements Initializable {
  ...
  String intro = "In the distance, you see an emtpy house. You come up to the house. \n WHat would like to a do? ";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    public void go_South() throws IOException {
     if (locations[11] == false) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Attackjunction12.fxml"));
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Junction12.fxml"));
    ...
    public void go_North() throws IOException {
        Stage Stage = new Stage();
        Stage.setTitle("Eastern Crossing");
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Easterncrossing.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
    ...
    public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/Davenrun/Cave4room1.fxml"));
    ...
    public void go_East() throws IOException {
        Stage Stage = new Stage();
        Stage.setTitle("Dungean");
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/House2.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
