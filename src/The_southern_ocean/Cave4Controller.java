...
String intro = " You come to giant jellyfish undercave. \n Here the Island man eating Jellyfish lurk within the cave. These jellyfish are \n 5 feet tall and have stinger that kill even the strongest adventure. \n There is a sign on the wall of the cave If you wish to find the \n second clue of the evil of island, go within” \n As you read the sign water crashes the print making unable to \n read for a brief period of time. \n The water crashes your feet you smell the seasalt like a fisherman wanting to find a fish. \n Do you wish to venture into the unkowsn of the cave? ";  
...
//ObservableList<String> people = FXCollections.observableArrayList();
  ...
  Stage Stage = new Stage();
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/House1.fxml"));
    ...
    public void go_North() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Attackjunction7.fxml"));

        Stage stage = new Stage();

        stage.setTitle("Junction 7");
        stage.setScene(new Scene(root, 1000, 750));
        stage.show();
        closeWindow();
    }
        if (locations[6] == true) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/junction7.fxml"));
    ...
    public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Cave4room1.fxml"));
    ...
    public void go_East() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Junction6.fxml"));

        Stage stage = new Stage();

        stage.setTitle("Junction 6");
        stage.setScene(new Scene(root, 1000, 750));
        stage.show();
        closeWindow();
