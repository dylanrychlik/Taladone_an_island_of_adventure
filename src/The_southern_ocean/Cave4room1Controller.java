...
public class Cave4room1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You go inside the cave. There is a man dead on the ground \n eletric burns all over his body. You then a hear a suttle buzz in from the other room. \n The buzz get louder and louder and louder. You then see a man running out. ''Go out! They are coming!!'' \n The man then trips to the ground. The giant jelly fish then zap the man as he screams. The man then dies. You go and attack";
        prompt.setText(intro);
        enmies.add("jellyfish");
        enmies.add("jellyfish");
        enmies.add("jellyyfish");
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Cave4room2.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 4");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
