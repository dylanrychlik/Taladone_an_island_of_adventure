 ...
 * @author The flash
 */
public class Cave7room3Controller implements Initializable {
 private Player you;
    int Enemyhealth = 10;
    String intro;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You see the King of the Giant snapping and attack";
        prompt.setText(intro);
        enmies.add("Giant snapping turtle king");
   ...
   locations[18] = true;
            ...
            alert.setTitle("Confirmation!");
Player.addbank(150);
            alert.setContentText("Cave cleared! You add 150 gold. Your gold is now "+ Player.getbank() +  "You find the Health potion of extreme. \n  Do you wish to equip it to add  to your health rating or do to add it to your inventory?"
                    + "");
