 ...
 * @author The flash
 */
public class Dragons_lairController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "Welcome to the Sea Monster lair. Here is where the evil Sea Monster of taladone sleeps. \n You have travel a long jounrey to right tis evil Sea Monster. \n Beyond this lair is the southern coast of Taladone. You hear \n a giant roar as you step around the cornor and fight the Sea Monster.";
        prompt.setText(intro);
        enmies.add("The Sea Monster of Taladone");
...
Player.addactarmor(1000);
Player.addhealth(1000);
Player.setATTACKDAMAGE(1000);
