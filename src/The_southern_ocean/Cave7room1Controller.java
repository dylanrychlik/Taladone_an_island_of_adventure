...
public class Cave7room1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You see a turtle snap a man and break his spine you go and attack.";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Cave7room2.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 7");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
