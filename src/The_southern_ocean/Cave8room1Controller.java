 ...
 * @author The flash
 */
public class Cave8room1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You go inside the cave and see the man fighting the merman. \n One of them grab the mans body and snaps it in half with sheer force. \n They then go and attack you.";
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
              ...
              //  Thread.sleep(3000);
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_southern_ocean/Cave8room2.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 8");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
