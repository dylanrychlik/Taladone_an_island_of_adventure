...
intro = "You march in the cave and see 3 warriors with a woman who is tied up. \n The warriors are performing an ancient ritual from the god of Taladone. \n ''Let a slow and painful death come to the main lander! God of Taladone, crush this main lander! \n Consume their soul!''. The god comes out and uses force to crush the bones and organs of \n the woman. The god disapears and you attack the warriors. ";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave4room2.fxml"));
                Stage stage = new Stage();
