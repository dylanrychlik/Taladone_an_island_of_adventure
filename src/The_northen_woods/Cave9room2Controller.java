...
public class Cave9room2Controller implements Initializable {
  ...
  private Player you;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "As you continue on the cave five more see their dead breathens and \n then rage hell on you.";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave9room3.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 9");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
