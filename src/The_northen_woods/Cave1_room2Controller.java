...
public class Cave1_room2Controller implements Initializable {
 ...
 intro = "''Thank you adventurer!'' said the little girl. ''Now I must go back to the Centeral region. \n Kill these wolfs so no one else has to fear. You nod your head as your go''";  
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave1_room3.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 1");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
