...
import static The_northen_woods.Junction2Controller.row12;
...
public class Cave1Controller implements Initializable {
    String intro = " You come to wolfthrowns cave.\n You hear the howls of the cave from inside. You know you will fighting big timber wolfs. \n If you go insdie who knows what treasures lay inside. Do you want to go inside?";
 ...
 StringBuilder builder = new StringBuilder(row1.size());
    ...
    public void go_Southeast() throws IOException {
     if (locations[1] == false) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/attackJunction2.fxml"));
   ...
   public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave1_room1.fxml"));
    ...
    public void go_East() throws IOException {
        ...
        if (locations[2] == true) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Junction3.fxml"));
