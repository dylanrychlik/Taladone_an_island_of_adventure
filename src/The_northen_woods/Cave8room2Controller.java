...
public class Cave8room2Controller implements Initializable {
   ...
   private Player you;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You then go inside and see another man fending off five of them. \n A stinger then goes though his arse and out the top of his head. \n The scorpian thens goes and attacks.";
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
              ...
              //  Thread.sleep(3000);
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave8room3.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 8");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
