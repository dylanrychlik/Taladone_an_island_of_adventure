...
public class Attackjunction8Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You travel the 8th junction of the northen region. "
                + "Up ahead you see a dead body \n with a chunck of their meat gone. \n A creature as been here. The blood drip all the way to the tree and \n a package."
                + "In the package there is a note that says \n “Day 27 of being trapped in the northen woods. There are man sized lizards near by” \n You put the note down and pack up. \n In the side of your eyes was a figure running by."
                + " You see a bush rustle, \n and more movement in your side veiw. \n You look around to your right and then turn to your behind, then your left, \n to the front again to hear a noise from behind you. You look behind you and \n see a small pack of raptors running straight towards you. \n You take your sword and charge agasint them.";
