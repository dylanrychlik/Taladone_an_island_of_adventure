 ...
 * @author The flash
 */
public class AttackJunction3Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        intro = "You travel east to the fith junction of the northen region. The sun is beating on \n your face like your father when you were a kid. \n As you wipe the sweat on your forehead, you notice a tad bit a red drip on your hand \n as you wipe it. You look up and see blood dripping from the leaves above. \n Upon further inpection, you see the dead body hanged up high from the tree. \n You turn around the cornor and see two more dead. \n There is a mad man on the loose. \n You grab your sword and scream! \n “Show yourself! I work for the Jarl! You don’t want to fight me!”. \n You then hear rustling from the leaves from the near by bush. \n Out comes an unarmed man that looks very frighten and scared. \n “Get out of here now! They are coming!” He says. \n An arrow then penatrates him and the man closped to the ground as his breath \n is cut short and reavles a group of outlaw travelers. ";
