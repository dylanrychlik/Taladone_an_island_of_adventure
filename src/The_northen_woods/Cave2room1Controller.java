 ...
 * @author The flash
 */
public class Cave2room1Controller implements Initializable {
...
intro = "A man stands right inside the cave. He is wounded and scared. \n''A group of banits attacked me and I hid insdie here!''. The lions come and \n eat the man alive. Tearing the flesh off of the man and pucnting his \n  organs as blood shoots out of his the body. \n The lions then come and attack you."; 
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave2room2.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 2");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
