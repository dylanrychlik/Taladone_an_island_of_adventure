...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    public void go_NorthEast() throws IOException {
        ...
        if (locations[1] == true) {
            Stage Stage = new Stage();
            Stage.setTitle("Junction 2");
            Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Junction2.fxml"));
    ...
    public void go_NorthWest() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Golden_Wine_berry_inn.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
