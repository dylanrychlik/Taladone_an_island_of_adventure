...
import static The_northen_woods.Junction1Controller.row10;
import static The_northen_woods.Junction1Controller.row11;
import static The_northen_woods.Junction1Controller.row12;
import static The_northen_woods.Junction1Controller.row5;
import static The_northen_woods.Junction1Controller.row6;
import static The_northen_woods.Junction1Controller.row7;
import static The_northen_woods.Junction1Controller.row8;
import static The_northen_woods.Junction1Controller.row9;
...
import static The_northen_woods.Northen_bridgeController.row12;
...
public class Golden_Wine_berry_innController implements Initializable {
    ...
    String intro = "You travel north into the woods. The journey is long in the hot summer sun in the island. \n You feel tired from the walk and the heavy weight. \n You come to the Goldenwineberry Inn. It's the only Inn in Taladone that is not in the \n central region \n You have along jounrey ahead of you before you kill the Dragon of Taladone. \n You could goinside for a rest and drink or conintuie on the Jounrey \n ";
