...
public class Attackjunction7Controller implements Initializable {
 ...
 intro =  "You travel to the 7th first junction of the northen region \n"+
       "You have your sword drawn as you prepare for battle as up ahdead 3 giant spiders are attacking. ";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Player.gethealth() < 0) {
            ...
            if (result.get() == Yes) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/attackJunction6.fxml"));
