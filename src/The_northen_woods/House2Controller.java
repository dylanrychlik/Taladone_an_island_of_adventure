...
import static The_northen_woods.House1Controller.row10;
import static The_northen_woods.House1Controller.row11;
import static The_northen_woods.House1Controller.row12;
import static The_northen_woods.House1Controller.row5;
import static The_northen_woods.House1Controller.row6;
import static The_northen_woods.House1Controller.row7;
import static The_northen_woods.House1Controller.row8;
import static The_northen_woods.House1Controller.row9;
...
public class House2Controller implements Initializable {
    ...
    String intro = "You come to another house. It is the most northen house in the island. \n You see a man standing outisde. What will you do? ";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    public void go_North() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Easterncrossing.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
    ...
    public void go_East() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/House2.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
