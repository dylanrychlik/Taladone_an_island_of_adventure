...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    public void go_South() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave7.fxml"));
    ...
    public void go_North() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/attackjunction10.fxml"));
        ...
        if (locations[9] == true) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Junction10.fxml"));
