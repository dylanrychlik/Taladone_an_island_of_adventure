...
intro = "You see a man tied up while the warriors are killing his wife and kids. \n ''Leave my family alone you savages'' - the man cries out. \n The warriors use an acient weapon that pulls the organs out of \n the man's family from their tounge. \n Blood spews everywhere while organ after organ comes out. The man watches \n begging for mercy. The man cries and tries to escape. \n An arrow then goes through his eyes right into his brain and out through the back,\n killing him insantly. You go and attack.";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave4room3.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 4");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
