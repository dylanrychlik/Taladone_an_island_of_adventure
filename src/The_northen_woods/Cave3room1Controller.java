 ...
 * @author The flash
 */
public class Cave3room1Controller implements Initializable {
...
intro = "You go inside the cave and see the a group of banits walking around the cave. \n ''You hear something?'' A banit called out. \n ''It's nothing you trash go get the gold'' - says another. \n You then jump out and the banits looks and says ''You never should of came here!''. \n You take your sowrd and charge!";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave3room2.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 3");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
