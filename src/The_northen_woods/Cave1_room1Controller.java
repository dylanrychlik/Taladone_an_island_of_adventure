 ...
 * @author The flash
 */
public class Cave1_room1Controller implements Initializable {
 ...
 intro = "You go inside the cave. It is dark and cold. You feel the wind from the northen woods, \n then all of the sudden howls appear from near by, from the Shawdows \n realves a lost little girl \n ''Help me! The wolfs are going to get me!'' said the little girl \n The wolfs come and attack, you run to save the little girl! It is war now";  
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave1_room2.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 1");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
