 ...
 * @author The flash
 */
public class Dungeonroom1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You go in and down the stairs and see books. The books are the \n acient arcivhes of Taladone. \n You go read a book. A man inturrups. ''What are you doing here?''  \n ''I'm on a mission''. You say. ''You shouldn't be here. I'm the keeper of the dungeon. \n My raptor team will kill you or make you suffer!'' - said the man \n and Two raptors come and them and the man charge";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/dungeonroom2.fxml"));
                Stage stage = new Stage();
    ...
    public void run() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/dungeon.fxml"));
        Stage stage = new Stage();
        stage.setTitle("Dungeon");
        stage.setScene(new Scene(root, 1000, 750));
        stage.show();
