...
public class Cave8Controller implements Initializable {
    ...
    String intro = "You travel scoripia string cave. \n Inside the cave is the king scoripoif of taladone \n These creature have stringer large enough to penetrate the skin of anyone \n who lurks in. \n If these creature are cleared no one has to fear of sporicians when travel \n the north forrst.";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    private void doAction2(String listItem) {
      ...
      public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave8room1.fxml"));
    ...
    public void go_North() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/junction9.fxml"));
      ...
      public void go_East() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave9.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
