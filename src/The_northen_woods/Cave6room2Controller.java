...
public class Cave6room2Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You see the dead corposes and all of then have red coated blood with chuncks of \n meat around them. The Skeltans march and attack.";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave6room3.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 6");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
