...
public class Attackjunction10Controller implements Initializable {
 ...
 intro =  "You sit to grab anther drink. \n Fro the around the cornor. \n You see a small family of giant snakes slithering towards you."; 
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Player.gethealth() < 0) {
            ...
            if (result.get() == Yes) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/attackJunction9.fxml"));
