 ...
 * @author The flash
 */
public class Dungeonroom3Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You get deeper in the dungeon. You see a teenager boy in there. \n He is on her knees praying suddely, \n from the next room 3 raptors come and eat him alive. \n You go and attack. ";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
           ...
           //     Thread.sleep(3000);
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/dungeonroom4.fxml"));
                Stage stage = new Stage();
