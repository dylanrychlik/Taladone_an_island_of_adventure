...
public class Dungeonroom4Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You get deeper in the dungeon. You see an old woman in here 80s. ''Beware traveler. \n The raptors will stop at nothing to kill you... and \n every thing you love.'' The woman then take a sword and stabs her self and 10 raptors come from \n differnt rooms and feed on the dead woman. The raptors then come attack you.";
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
              ...
              //  Thread.sleep(3000);
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/dungeonroom5.fxml"));
                Stage stage = new Stage();
