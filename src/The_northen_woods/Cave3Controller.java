...
import static The_northen_woods.Cave2Controller.row10;
import static The_northen_woods.Cave2Controller.row11;
import static The_northen_woods.Cave2Controller.row5;
import static The_northen_woods.Cave2Controller.row6;
import static The_northen_woods.Cave2Controller.row7;
import static The_northen_woods.Cave2Controller.row8;
import static The_northen_woods.Cave2Controller.row9;
...
import static The_northen_woods.Junction2Controller.row10;
import static The_northen_woods.Junction2Controller.row11;
import static The_northen_woods.Junction2Controller.row5;
import static The_northen_woods.Junction2Controller.row6;
import static The_northen_woods.Junction2Controller.row7;
import static The_northen_woods.Junction2Controller.row8;
import static The_northen_woods.Junction2Controller.row9;
...
import static The_northen_woods.Northen_bridgeController.row5;
import static The_northen_woods.Northen_bridgeController.row6;
import static The_northen_woods.Northen_bridgeController.row7;
import static The_northen_woods.Northen_bridgeController.row8;
import static The_northen_woods.Northen_bridgeController.row9;
...
public class Cave3Controller implements Initializable {
    ...
    String intro = " You travel to Northen region banit hideout. \n This is where all the banits that haunt the northen forrest are. \n Inside the cave is the banit leader. If these banits are cleared, \n then there will be much less crimes \n and murder around the island... from banits that is. \n Who knows what treasure asre inside from the greedy banits who stoled \n from familys around the island. \n You grib your sword as you decidce what to do. Do you wish to go in the cave?";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    public void go_NorthEast() throws IOException {
        ...
        if (locations[4] == false) {
            Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/AttackJunction5.fxml"));
        ...
        if (locations[4] == true) {
            Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Junction5.fxml"));
    ...
    public void go_North() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave5.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
    ...
    public void go_West() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave2.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
    ...
    public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave3room1.fxml"));
    ...
    public void go_East() throws IOException {
            ...
            Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Junction4.fxml"));
