 ...
 * @author The flash
 */
public class Cave7room2Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You see a large man standing fending off from the snakes. One them grabs him \n and swallows him whole. The five snakes then go and attack you. \n You grab yoru sword and charge.";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave7room3.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 7");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
