 ...
 * @author The flash
 */
public class Cave5room1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You go inside the cave and a man just standing there. He looks slilent and frightened. \n ''Are you Jesus Christ here to save me? Please Lord forigve for me evil sins \n against the mightys worshipness!'' The damned Zombies took my wife and kids. \n Please take me too so I can go to the kingdom of heavan with them. \n The Zombies then come from behind and attack the man and tear his flesh like paper.\n  Soon his red coated bones are showing and he bleeds out and falls to the ground. ";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave5room2.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 5");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
