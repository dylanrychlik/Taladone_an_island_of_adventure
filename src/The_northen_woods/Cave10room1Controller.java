...
public class Cave10room1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You go inside the cave. From inside you see a man, he looks very frighting. \n ''Help me! I got lost out here they are coming! They are comming!'', \n the locus them shows up, a locus jumps on the nearly nakeed man, \n and then bites his skins on his back \n and then he sucks the mans blood and put posion in it. \n ''Ah!!! AHHH!!!!!'' The man screams! \n ''Help me! Get this thing off of me! HELP ME! HELP ME!''. The man screams in agony. \n With half of his bloood gone, he becomes weaker and weaker. His body is covered in dark blue vains. \n He can barley breath. Evenrually he stops talking because he can't breath. \n His eyes roll to the back of head, and his eyes are white as a ghost. \n Then posion comes out of his eyes and mouth and the man falls to the ground with posion ozzing out of his wound. /n The locus then screams at you at then a couple of more join along and attack.";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Player.gethealth() < 0) {
            ...
            if (result.get() == Yes) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave10.fxml"));
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Cave10room2.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 10");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
