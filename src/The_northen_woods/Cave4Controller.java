...
import static The_northen_woods.Cave10Controller.row10;
import static The_northen_woods.Cave10Controller.row11;
import static The_northen_woods.Cave10Controller.row12;
import static The_northen_woods.Cave10Controller.row5;
import static The_northen_woods.Cave10Controller.row6;
import static The_northen_woods.Cave10Controller.row7;
import static The_northen_woods.Cave10Controller.row8;
import static The_northen_woods.Cave10Controller.row9;
...
String intro = " You travel to warriors cave. It is the hideout of taladones great warriors. \n It holds the Island acient warriors. They are the orginal race that have hold the island \n They are all that left of the warriors before the roman empire invaded hundereds \n of years ago. They kill anyone who isn't one of them. \n They kill anyone who isn't one of them.";
...
//ObservableList<String> people = FXCollections.observableArrayList();
  ...
  Stage Stage = new Stage();
    ...
    public void go_North() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/Attackjunction7.fxml"));
        ...
        if (locations[6] == true) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_northen_woods/junction7.fxml"));
