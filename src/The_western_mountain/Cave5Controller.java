...
public class Cave5Controller implements Initializable {
    String intro = "You come to third doogieahead cave. Here is where a group of \n doogies heads and deamons live within. Do you dare go isnide?";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    private void doAction2(String listItem) {
      ...
      public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave5room1.fxml"));
 ...
 Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave3.fxml"));
    ...
    public void go_North() throws IOException {
        Stage Stage = new Stage();
        Stage.setTitle("Cave 7");
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave7.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
