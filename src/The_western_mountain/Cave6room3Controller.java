 ...
 * @author The flash
 */
public class Cave6room3Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     intro = "You see the last of the frost trolls and you attack";
        prompt.setText(intro);
        enmies.add("Frost troll");
        enmies.add("Frost troll");
        enmies.add("Frost troll");
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            alert.setTitle("Confirmation!");
Player.addbank(150);
            alert.setContentText("Cave cleared! You add 150 gold. Your gold is now "+ Player.getbank() +  "You find the Health potion of extrem and sword. \n  Do you wish to equip it to add  to your health rating or do to add it to your inventory?"
                    + "");
            ...
            Optional<ButtonType> result = alert.showAndWait();
            if (result.get() == Yes) {
             goodItem  Cave4Weapon = new   goodItem("6","Plentful health","Plentful health found in General Goods store in Davenrun.",75,75);
          Weapon Cave3Weapon = new Weapon ("6","Heavy sword","Two handed steel sword forged by John warion",100,100);
