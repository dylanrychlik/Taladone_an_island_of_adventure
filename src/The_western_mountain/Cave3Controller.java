...
import static The_western_mountain.Cave2Controller.row10;
import static The_western_mountain.Cave2Controller.row11;
import static The_western_mountain.Cave2Controller.row5;
import static The_western_mountain.Cave2Controller.row6;
import static The_western_mountain.Cave2Controller.row7;
import static The_western_mountain.Cave2Controller.row8;
import static The_western_mountain.Cave2Controller.row9;
...
import static The_western_mountain.Junction2Controller.row10;
import static The_western_mountain.Junction2Controller.row11;
import static The_western_mountain.Junction2Controller.row5;
import static The_western_mountain.Junction2Controller.row6;
import static The_western_mountain.Junction2Controller.row7;
import static The_western_mountain.Junction2Controller.row8;
import static The_western_mountain.Junction2Controller.row9;
...
import static The_western_mountain.Northen_bridgeController.row5;
import static The_western_mountain.Northen_bridgeController.row6;
import static The_western_mountain.Northen_bridgeController.row7;
import static The_western_mountain.Northen_bridgeController.row8;
import static The_western_mountain.Northen_bridgeController.row9;
...
public class Cave3Controller implements Initializable {
    ...
    String intro = "You come to west raptor cave. \n Here a group of raptors lives within. Do you dare go insider? ";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    public void go_NorthEast() throws IOException {
        ...
        if (locations[4] == false) {
            Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/AttackJunction5.fxml"));
        ...
        if (locations[4] == true) {
            Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Junction5.fxml"));
    ...
    public void go_West() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave2.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
    ...
    public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave3room1.fxml"));
