 ...
 * @author The flash
 */
public class Cave6room2Controller implements Initializable {
   ...
   intro = "You see a frost troll maul a man as his arm comes off. \n Four more come as the first maul the mans to death...  you attack";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave6room3.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 6");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
