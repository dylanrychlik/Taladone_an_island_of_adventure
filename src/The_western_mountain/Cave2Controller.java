...
public class Cave2Controller implements Initializable {
    ...
    String intro = "You come to second doogieahead cave. Here is where a group of \n doogies heads and deamons live within. Do you dare go isnide?";
...
row1.clear();
    ...
    private void doAction2(String listItem) {
      ...
      public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave2room1.fxml"));
