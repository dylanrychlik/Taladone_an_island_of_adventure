...
public class Cave10room2Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You go and see more dead elk with chunks\n  of meat around red coated blood. The yetis attack";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave10room3.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 10");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
