...
public class Cave10Controller implements Initializable {
    ...
    String intro = " You come to yeti cave. Within the cave is a group of yeti do yo dare go inside?";
...
//ObservableList<String> people = FXCollections.observableArrayList();
  ...
  row1.clear();
    ...
    public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave10room1.fxml"));
    ...
    public void go_North() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/dungeon.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
    ...
    public void go_East() throws IOException {
        if (locations[9] == false) {
            Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Attackjunction12.fxml"));
        ...
        if (locations[11] == true) {
            Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Junction12.fxml"));
