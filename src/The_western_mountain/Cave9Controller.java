...
public class Cave9Controller implements Initializable {
    String intro = "You come to the fifth doogies cave. Here is where a group of \n  doogies heads and deamons live within. Do you dare go isnide?";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    private void doAction2(String listItem) {
      ...
      public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave9room1.fxml"));
    ...
    public void go_North() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/attackjunction10.fxml"));
        ...
        if (locations[9] == true) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Junction10.fxml"));
