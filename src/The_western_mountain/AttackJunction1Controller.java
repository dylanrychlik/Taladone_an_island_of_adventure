...
public class AttackJunction1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        intro = "You come to the First Junction in the Western region. \n The sun is setting behind the mouantina and dusk in falling. \n As you approach the cornor you see feel a strage feeling inside. \n You are not alone. \n You turn around the cornor.. It seems quite. ";
