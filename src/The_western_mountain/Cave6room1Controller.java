...
public class Cave6room1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You see a frost troll crawl in full towards you. Two more come and you attack";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave6room2.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 6");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
