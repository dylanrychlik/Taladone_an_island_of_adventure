...
public class Cave10room3Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You go and see a man chained up. He has bruizes and \n scars all over his naked body. \n His cuts are frozen. \n ''Don't let the yeti get you... you'll nothing but pain'' - said the man as he sivers. \n He then freezes to death and 3 remaining yeti go and attack";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Player.gethealth() < 0) {
            ...
            if (result.get() == Yes) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave10.fxml"));
