...
public class Dungeonroom1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You in a see 3 headless men. They tear the \n flesh of a helpless man man apart. You go and attack. ";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/dungeonroom2.fxml"));
                Stage stage = new Stage();
