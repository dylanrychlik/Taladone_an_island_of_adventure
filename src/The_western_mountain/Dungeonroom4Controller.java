...
public class Dungeonroom4Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You get deeper in the dungeon. You see an old man in his 80s. ''Beware traveler. \n The doogie heads will stop at nothing to kill you... and \n every thing you love.'' \n The man then take a sword and stabs him self and 10 doogie heads come from \n differnt rooms and feed on the dead woman. The raptors then come attack you.";
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
              ...
              //  Thread.sleep(3000);
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/dungeonroom5.fxml"));
                Stage stage = new Stage();
