 ...
 * @author The flash
 */
public class Attackjunction10Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You coem to the 10 Junction in the westerm region. \n As you walk snows begins to move. Int he snow the words are wriiten that says \n ''Turn back now''. \n  A blizzard is forming the maoutnain. You can braley see.\n In the distsacd a large human looking figure is formed. \n It a man. You look at man and say “There createures are coming run” \n And the man runs off. As you draw your sowrd asquad of doogiehead and \n demons become visiible. Time for battle.";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Player.gethealth() < 0) {
            ...
            if (result.get() == Yes) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/attackJunction9.fxml"));
