...
public class Cave3room1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You and see a man appears to be dead. As he attempts to get up \n A raptor comes and crushes his skulls. \n You go and attack";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave3room2.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 3");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
