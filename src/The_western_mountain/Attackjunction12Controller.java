...
public class Attackjunction12Controller implements Initializable {
 ...
 intro =  "You travel 12th junction of the western region. \n You come to the 12th jucntion in the wester region. \n You turn around the cornor to see a Spinosaurous \n scaring directly at you it roars and \n it consumes a smaller dinosuar from near by. \n You grab your sword and charge. ";
 prompt.setText(intro);
      enmies.add("Spinosaurous");
