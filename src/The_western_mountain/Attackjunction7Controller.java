...
public class Attackjunction7Controller implements Initializable {
 ...
 intro =  "You come to the 7th Junction in the western region. \n You come to the 7th junction in the northen region. \n There is little bend in the path that leads to the top. \n As you turn around the cornorer you see a yeti in the distance it turn around as blood and \n meat is dripping from the elk it has consumed from its mouth \n It looks directlyl at you and run towards you. You draw your sowrd. ";  
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Player.gethealth() < 0) {
            ...
            if (result.get() == Yes) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/attackJunction6.fxml"));
