...
public class DungeonController implements Initializable {
    ...
    String intro = "You come to the doogiehead dunoea. Here the headless doogieheas \n of Taladone haunt the underlands. DO you dare go inside? ";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/dungeonroom1.fxml"));
    ...
    public void go_North() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Westerncrossing.fxml"));
    ...
    public void go_East() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/house2.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
