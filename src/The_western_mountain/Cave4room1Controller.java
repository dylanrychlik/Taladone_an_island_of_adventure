...
public class Cave4room1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        intro = "You go and see a man. A spier comes and stabs the man with his fangs. \n His gets injected with exteme posion and then falls to the ground. \n Two more spiders appear and you go and attack.";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave4room2.fxml"));
                Stage stage = new Stage();
