...
//ObservableList<String> people = FXCollections.observableArrayList();
  ...
  Stage Stage = new Stage();
    ...
    public void go_North() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Attackjunction7.fxml"));
        ...
        if (locations[6] == true) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/junction7.fxml"));
