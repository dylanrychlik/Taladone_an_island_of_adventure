...
String intro = "You come to mauntiant warrior cave. Here a group of mauntiant \n warriors live insider. They kill anything that comes inside the cave. \n If this cave is cleared no longer will a traveler have to die. Do you dare go inside?";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    private void doAction2(String listItem) {
      ...
      public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave7room1.fxml"));
