...
public class Cave6Controller implements Initializable {
   ...
   String intro = "You come to frost troll cave. Here a group of frost troll live within do you dare go inside?";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    private void doAction2(String listItem) {
      ...
      public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave6room1.fxml"));
