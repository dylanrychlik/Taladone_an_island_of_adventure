...
public class Junction4Controller implements Initializable {
    String intro = " You come to the fourth Junction in the western region. \n  The blizzard get stronger. \n From behind you a crackeling from a tree. \n ''Turn back adventure this is your last chance'' \n Brave and bold you avoide the tempation to go back. And march foward. \n There are no emies in this area!";
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    public void go_Southeast() throws IOException {
        ...
        Stage Stage = new Stage();
        Stage.setTitle("Golden wine berry in");
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Golden_Wine_berry_inn.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
