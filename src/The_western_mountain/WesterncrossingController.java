...
public class WesterncrossingController implements Initializable {
    ...
    String intro = "Welcome to the south crossing of the western mountain. Beyond this dark hallways, is the top mountain. Do you wish to ahhilate it?";
...
//ObservableList<String> people = FXCollections.observableArrayList();
  ...
  row1.clear();
    ...
    public void go_inside() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Insidewesterncrossing.fxml"));
