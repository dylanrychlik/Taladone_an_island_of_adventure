...
import static The_western_mountain.Cave10Controller.row10;
import static The_western_mountain.Cave10Controller.row11;
import static The_western_mountain.Cave10Controller.row12;
import static The_western_mountain.Cave10Controller.row5;
import static The_western_mountain.Cave10Controller.row6;
import static The_western_mountain.Cave10Controller.row7;
import static The_western_mountain.Cave10Controller.row8;
import static The_western_mountain.Cave10Controller.row9;
import static The_western_mountain.Junction1Controller.row13;
import static The_western_mountain.Junction5Controller.row10;
import static The_western_mountain.Junction5Controller.row11;
import static The_western_mountain.Junction5Controller.row5;
import static The_western_mountain.Junction5Controller.row6;
import static The_western_mountain.Junction5Controller.row7;
import static The_western_mountain.Junction5Controller.row8;
import static The_western_mountain.Junction5Controller.row9;
...
public class Cave8Controller implements Initializable {

 String intro = " You come to the fourth doogies cave. Here is where a group of doogies heads \n and deamons live within. Do you dare go isnide?";
  ...
  row1.clear();
    ...
    private void doAction2(String listItem) {
      ...
      public void go_inside_boldmans_areana() throws IOException {
        ...
        Stage.setTitle("Inside Cave 8");
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave8room1.fxml"));
    ...
    public void go_South() throws IOException {
      ...
      if (locations[7] == false) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/attackjunction8.fxml"));
        ...
        if (locations[7] == true) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/junction8.fxml"));
    ...
    public void go_North() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/junction9.fxml"));

        Stage stage = new Stage();

        stage.setTitle("Junction 9");
        stage.setScene(new Scene(root, 1000, 750));
        stage.show();
        closeWindow();
      ...
      public void go_East() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave9.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
