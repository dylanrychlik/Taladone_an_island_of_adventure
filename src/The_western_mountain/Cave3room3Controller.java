 ...
 * @author The flash
 */
public class Cave3room3Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
       intro = "You see the last of raptors and attack!";
enmies.add("Raptor");
enmies.add("Raptor");
enmies.add("Raptor");
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
           ...
           //  intro += "You add 100 gold. You bank is now " + Player.getbank();
             intro += "''Thank you adventurer.'' - said the woman. \n ''I am forever in my debt'' - said the woman. \n ''I'm just doing my job, miss'' - you said. \n The woman takes 3 three children and leaves the cave.";
              locations[14] = true;
                Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
            alert.setTitle("Confirmation!");
Player.addbank(150);
            alert.setContentText(intro + "Cave cleared! You add 150 gold. Your gold is now "+ Player.getbank() +  "You find the Health potion of extreme, iron axe, and armor. \n  Do you wish to equip it to add  to your health rating or do to add it to your inventory?"
                    + "");
            ...
            Optional<ButtonType> result = alert.showAndWait();
            if (result.get() == Yes) {
             goodItem  Cave4Weapon = new   goodItem("6","Extreme health","Extreme health found in General Goods store in Davenrun.",110,120);
          Weapon Cave3Weapon = new Weapon ("6","Iron axe","Iron axe forged by John warion",50,50);
          Weaponitem.addLast(Cave3Weapon);
          Armor Cave3Armor = new Armor("6","Armor","Armor forged by John Wariron",30,30);
          Armoritem.addLast(Cave3Armor);
