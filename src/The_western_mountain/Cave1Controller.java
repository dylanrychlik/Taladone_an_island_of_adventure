...
import static The_western_mountain.Junction2Controller.row12;
...
public class Cave1Controller implements Initializable {
    String intro = "You come to first doogieahead cave. Here is where a group of \n doogies heads and deamons live within. Do you dare go isnide?";
...
//ObservableList<String> people = FXCollections.observableArrayList();
  ...
  row1.clear();
    ...
    public void go_NorthWest() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cabin.fxml"));
    ...
    public void go_Southeast() throws IOException {
     if (locations[1] == false) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/attackJunction2.fxml"));
   ...
   public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave1_room1.fxml"));
    ...
    public void go_East() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/attackjunction3.fxml"));
        ...
        if (locations[2] == true) {
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Junction3.fxml"));
