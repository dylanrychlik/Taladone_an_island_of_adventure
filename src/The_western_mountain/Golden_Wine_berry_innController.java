...
import static The_western_mountain.Junction1Controller.row10;
import static The_western_mountain.Junction1Controller.row11;
import static The_western_mountain.Junction1Controller.row12;
import static The_western_mountain.Junction1Controller.row5;
import static The_western_mountain.Junction1Controller.row6;
import static The_western_mountain.Junction1Controller.row7;
import static The_western_mountain.Junction1Controller.row8;
import static The_western_mountain.Junction1Controller.row9;
...
import static The_western_mountain.Northen_bridgeController.row12;
...
public class Golden_Wine_berry_innController implements Initializable {
    ...
    String intro = "You come to an adbanded inn in the mountain. What will you? ";
    ...
    public void Golden_Wine_berry_innController() {
...
//ObservableList<String> people = FXCollections.observableArrayList();
    ...
    public void go_inside_boldmans_areana() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Inside_Golden_Wine_berry_inn.fxml"));
    ...
    public void go_East() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave1.fxml"));
        Stage.setScene(new Scene(root, 1000, 750));
        Stage.show();
        closeWindow();
    }
