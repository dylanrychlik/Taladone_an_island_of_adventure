...
public class AttackJunction3Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        intro = "You come to the third Junction in the western region. You have your \n hand by your side and sword drawn. The climb is steep and \n is hard to see, you turn around the conor and see doogie heads confronting you.  ";
