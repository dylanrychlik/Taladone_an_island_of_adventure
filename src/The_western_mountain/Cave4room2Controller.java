...
intro = "You see a lot of dead people with their blood gone. \n You see five spiders and you go and attack";
    ...
    public void attack() throws IOException, InterruptedException {
        ...
        if (Enemyhealth < 0) {
            ...
            if (enmies.isEmpty()) {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/The_western_mountain/Cave4room3.fxml"));
                Stage stage = new Stage();
                stage.setTitle("Cave 4");
                stage.setScene(new Scene(root, 1000, 750));
                stage.show();
